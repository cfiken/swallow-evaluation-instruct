...
ENTRIES=(
  ...
  #"openai/gpt-oss-20b,,,"
  "tokyotech-llm/Qwen3-Swallow-8B-v0.1-SFT-exp1-stage1-LR1.5E-5-iter0007800,qwen3,Please think in English and respond in Japanese.,"
)
