...
* 派生版
    ...
    * `swallow|jgpqa_N{8,16,32,64,128}:{diamond,main,extended}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
      推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|math_100_japanese_N{8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|gpqa_N{8,16,32,64,128}:diamond` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|math_500_N{8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|aime_N{8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
