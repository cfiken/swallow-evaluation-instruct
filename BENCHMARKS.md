...
### IFBench
「"whisper"を3回使え」のような検証可能な指示を用いて対話における指示追従性を評価するベンチマークです．  
...
* その他の評価尺度
    ...
    * 正規化後の指示レベルの正解率：instruct_level_loose_accuracy
    * 正規化後の設問レベルの正解率：prompt_level_loose_accuracy
* 実装の出典：[lighteval v0.11.0](https://github.com/huggingface/lighteval/tree/v0.11.0) で追加された標準実装をインポートして，出力トークン数制限を解除しています．  
