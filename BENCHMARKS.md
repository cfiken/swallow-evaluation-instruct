...
* CoTプロンプト：あり
* 評価尺度：正解率
* 派生版：`swallow|swallow_gpqa_ja_N{8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
...
* 派生版
    ...
    * `swallow|jgpqa_N{4,8,16,32,64,128}:{diamond,main,extended}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
      推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|math_100_japanese_N{4,8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|gpqa_N{4,8,16,32,64,128}:diamond` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|math_500_N{4,8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 派生版：`swallow|aime_N{4,8,16,32,64,128}` を指定することで，Pass@KおよびMaj@Kを評価できます．  
  推奨設定は temperature=0.6, top-p=0.95 です．
...
* 注意：シングルターン版のみに対応しています．マルチターン版には対応しておりません．